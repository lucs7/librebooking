    ...
    private function GetDescription($item)
    {
        ...
        $config = $resources->GetString(
            ...
            [
                ...
                (QuotaScope::IncludeCompleted == $item->Scope) ? $resources->GetString('IncludingCompletedReservations') : $resources->GetString('NotCountingCompletedReservations'),
        ...
        $scope = '';
        if (QuotaScope::IncludeCompleted == $item->Scope) {
