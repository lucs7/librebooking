...
class CalendarReservation
{
    ...
    public static function FromView($reservation, $timezone, $user, $factory = null)
    {
        ...
        $res->Invited = ReservationUserLevel::INVITEE == $reservation->UserLevelId;
        $res->Participant = ReservationUserLevel::PARTICIPANT == $reservation->UserLevelId;
        $res->Owner = ReservationUserLevel::OWNER == $reservation->UserLevelId;
