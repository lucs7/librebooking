<div class="form-group {$class}">
    ...
    {else}
        <select id="{$attributeId}" name="{$attributeName}" class="customAttribute form-select {if !$searchmode && $attribute->Required()}has-feedback{/if} {$inputClass}" {if $attribute->Required() && !$searchmode}required{/if}>
            <option value="">--</option>
