...
<div id="page-manage-announcements" class="admin-page">
	...
	<script type="text/javascript">
		$(document).ready(function() {
                        ...
                        tinymce.init(Object.assign({}, defaultTinyMceOptions, {selector: '#addAnnouncement'}));
                        ...
                        $(document).on('shown.bs.modal', '#editDialog', function() {
                                ...
                                tinymce.init(Object.assign({}, defaultTinyMceOptions, {selector: '#editText'})).then(function(editors) {
                                        editors[0].setContent(sanitizedHtml);
                                });
                        });
