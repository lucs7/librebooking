...
require_once(ROOT_DIR . 'tests/fakes/TestReservationCreatedEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestReservationDeletedEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestReservationShareEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestInviteeAddedEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestInviteeRemovedEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestGuestAddedEmail.php');
require_once(ROOT_DIR . 'tests/fakes/TestGuestDeletedEmail.php');
