...
class ReservationComponentTest extends TestBase
{
    ...
    public function testCheckInIsRequiredIfAtLeastOneResourceRequiresItAndReservationIsNotCheckedInAndWithinCheckinWindow()
    {
    ...
    public function testCheckOutRequiredIfAtLeastOneResourceRequiresItAndTheReservationHasStartedAndNotCheckedOut()
    {
        $page = new FakeExistingReservationPage();
        $this->reservationView->StartDate = Date::Now()->AddMinutes(-6);
        $this->reservationView->EndDate = Date::Now()->AddMinutes(45);
    ...
    public function testAutoReleaseMinutesIsSetToMinimumAutoReleaseMinutesIfNotCheckedIn()
    {
        $page = new FakeExistingReservationPage();
        $this->reservationView->StartDate = Date::Now()->AddMinutes(6);
        $this->reservationView->EndDate = Date::Now()->AddMinutes(45);
