...
class ReservationEmailMessageTest extends TestBase
{
    ...
    public function testIcsAttachmentIncludesAttendeesForParticipantsInviteesAndGuestsButStaysPublish()
    {
        $ownerId = 1;
        ...
        // This attachment is always addressed to the reservation owner, never to one of
        // these attendees, so it must stay PUBLISH even though attendees are present.
