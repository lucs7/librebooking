...
class Net_LDAP2_Filter extends PEAR
{
     ...
     * @param bool   $escape    Should $value be escaped? (default: yes, see {@link Net_LDAP2_Util::escape_filter_value()} for detailed information)
     *
