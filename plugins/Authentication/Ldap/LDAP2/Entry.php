...
class Net_LDAP2_Entry extends PEAR
{
    ...
    public function update($ldap = null)
    {
        ...
        */
        ...
        foreach ($this->_changes['delete'] as $attr => $value) {
            ...
            if (is_null($value) && 3 === $ldap->getLDAPVersion()) {
     ...
     *
     * @param bool $mark Value to set, defaults to "true"
     *
     * @return void
     */
     ...
     *
     * @return bool|Net_LDAP2_Error TRUE, if we had a match in one of the values, otherwise false. Net_LDAP2_Error in case something went wrong
     */
